require "spec/helper"
require "env_ruby_racer"

describe EnvRubyRacer do
#FIXME: Segfault
#  it 'should create a stubbed environment with a div' do
#    js = EnvRubyRacer.new "", :body => "<div id='example'></div>"
...
#    js = EnvRubyRacer.new js_code, :body => "<div id='example'></div>"
#    js[:example].should == "Changed!"
#  end
#
#  it 'should save the last page' do
#    js_code = "document.getElementById('example').innerHTML = 'Changed'"
#    js = EnvRubyRacer.new js_code, :body => "<div id='example'>Before</div>"
